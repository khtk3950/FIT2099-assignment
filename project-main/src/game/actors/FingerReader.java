 ...
 * Finger Reader Enia
 */
public class FingerReader extends Actor {
    /**
     *Constructor
     * @param name name of the actor
     * @param displayChar  Char that represent the actor
     */
    public FingerReader(String name, char displayChar){
        super(name, displayChar, 100);
        this.addCapability(Species.READER);
    }
    /**
